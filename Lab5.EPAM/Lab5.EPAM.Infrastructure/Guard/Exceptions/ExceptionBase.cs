...
namespace Lab5.EPAM.Infrastructure.Guard.Exceptions
{
    /// <summary>
    ...
    public abstract class ExceptionBase : ApplicationException
    {
        ...
        private static readonly Lazy<FieldInfo> InnerExceptionFieldInfo =
            new Lazy<FieldInfo>(
        ...
        internal void SetInnerException(Exception innerException)
        {
            ...
            ExceptionBase.InnerExceptionFieldInfo.Value.SetValue(this, innerException);
